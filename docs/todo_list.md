...
1️⃣ Potvrdit počet a význam UI bloků (layout struktura)
 ...
 Definovat, co přesně je v každém bloku (např. „blok 5 = záložky s vazbami“, „blok 9 = přehled entit“)
...
2️⃣ Nakreslit finální rozložení obrazovky
 ...
 Definovat fixní části layoutu (sidebar, záhlaví, záložky...)

 Definovat proměnlivé části (detail entity, vazby...)

3️⃣ Popsat chování záložek (Tabs a Connections)

 Potvrdit fixní pořadí záložek (např. 1–10)

 Ujasnit, že hlavní karta zůstává vždy na stejné pozici (např. smlouva je vždy v záložce 6)

 Popsat, jak fungují seznam + detail (vždy spolu)

4️⃣ Upřesnit logiku vazeb mezi entitami

 Definovat strom: Pronajímatel → Nemovitost → Jednotka → Nájemník → Smlouva → Platby
...
5️⃣ Navrhnout přílohový systém
 ...
 Jak bude fungovat upload (formulář, drag & drop...)
