    ...
    async (c: UiContractRow, vm: 'read' | 'edit', sectionId: DetailSectionId = 'detail') => {
      try {
        ...
        const resolved: DetailUiContract = {
          ...
          landlordAccountId: (d as any).landlord_account_id,
          tenantAccountId: (d as any).tenant_account_id,
          landlordDelegateId: (d as any).landlord_delegate_id,
          tenantDelegateId: (d as any).tenant_delegate_id,
