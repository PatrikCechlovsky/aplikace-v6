// FILE: app/lib/services/propertyServices.ts
// PURPOSE: Service layer pro vazby služeb na nemovitost (property_services)
// NOTES: Používá view v_property_services_list pro přehled
...
export type SavePropertyServiceInput = {
  id?: string
  property_id: string
  service_id?: string | null
  name?: string | null
